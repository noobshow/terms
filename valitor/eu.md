...
**k.** Use all reasonable methods to resolve disputes with your Customers, including in relation to chargebacks, and not attempt to recharge a Customer for the transaction unless authorized by the Customer; and
