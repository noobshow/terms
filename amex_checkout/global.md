...
Last Updated: August 14, 2015. Previous versions and diffs are [available here](https://github.com/stripe/terms).
</header>
...
You will:
Process Amex Checkout Data in compliance with this Addendum, the Documentation, the Stripe Terms of Service and all laws and regulations, common laws, court orders, judgments, decrees, directives, policies rules or orders, in each case binding on you and your affiliates (“Applicable Laws”).
Maintain, monitor and enforce a data security program that, at a minimum, sets out the processes policies and controls to ensure compliance with this Section 3 and complies with all other requirements of this Addendum, the Stripe Terms of Service, Applicable Laws and the Payment Card Industry Data Security Standard (PCI-DSS), and other security standards that may be required by Amex or us from time to time.
...
Subject to your compliance with this Addendum, the Documentation, the Stripe Terms of Service and Applicable Laws, Stripe grants you a limited license to use the AEC Button, the AXP APIs and the Documentation to the extent necessary to utilize the Amex Service in conjunction with the Service.
...
In case of conflict between the terms of this Addendum and the Stripe Terms of Service, this Addendum shall prevail with respect to the Amex Service. All other terms of the Stripe Terms of Service remain in full force and effect.
